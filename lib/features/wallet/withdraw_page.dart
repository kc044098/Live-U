...
class WithdrawPage extends StatelessWidget {
  ...
  final double _availableAmount = 1000.00;
          ...
          TextButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const WithdrawDetailsPage(),
                ),
              );
            },
            child: const Text(
              '明細',
              style: TextStyle(fontSize: 14, color: Color(0xFFFF4D67)),
            ),
          ),
        ],
      ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      _accountController.clear(); // 提現帳戶
                      _nameController.clear();    // 提現戶名
                    },
                    style: ElevatedButton.styleFrom(
                      padding: EdgeInsets.zero,
                      shape: RoundedRectangleBorder(
