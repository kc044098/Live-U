...
class _BannerViewState extends State<BannerView> {
  ...
  void _handleScrollNotification(dynamic notification) {
  ...
  Widget _renderIndicator() {
    ...
    return new IndicatorWidget(
      this._originBanners.length,
      currentIndex: index,
      indicatorContainerBuilder: this.widget.indicatorBuilder,
