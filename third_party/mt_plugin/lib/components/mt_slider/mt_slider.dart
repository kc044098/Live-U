...
class MtSlider extends StatefulWidget {
  final Key? key;
  final Axis axis;
...
//        assert( fixedValues == null || (fixedValues != null && values.length > 1 && values[1] >= values[0] && values[1] <= 100), "When using fixedValues, you should set values within the range of fixedValues" ),
  ...
  @override
  _MtSliderState createState() => _MtSliderState();
}

class _MtSliderState extends State<MtSlider>
  ...
  @override
  void didUpdateWidget(MtSlider oldWidget) {
    __isInitCall = false;
