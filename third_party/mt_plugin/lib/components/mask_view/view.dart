...
import 'package:mt_plugin/components/mask_view/widget/child_view.dart';
...
///面具页面
class MaskView extends GetView {
  final logic = Get.put(MaskViewLogic());
  ...
  Widget build(BuildContext context) {
    //读取配置文件中的面具配置
    FileTools.instance.getMasks().then((value) {
      print("有${value?.length}个面具");
      state.items.clear();
