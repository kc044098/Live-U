...
class MaskChildView extends GetView {
  final ParamSingleCallback<Rx<Mask>> onTap;

  final MaskState state;

  MaskChildView({required this.onTap, required this.state});
  ...
  Widget _buildWidget(Rx<Mask> item, ParamSingleCallback<Rx<Mask>> onTap) {
    return Container(
      height: 200,
              ...
              children: [
                Positioned(
                  ...
                  child: CachedNetworkImage(
                    width: 44,
                    height: 44,
                    imageUrl: "${AppConfig.MT_URL}mask/${item.value.thumb}",
